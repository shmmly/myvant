...
export default sfc({
  ...
  computed: {
    ...
    faceAmount: function faceAmount() {
      return this.coupon.denominations ? "<span>" + formatcurrency(this.coupon.currency) + "</span> " + formatAmount(this.coupon.denominations) : this.coupon.discount ? t('discount', formatDiscount(this.coupon.discount)) : '';
    },
